// Compiled using marko@4.14.22 - DO NOT EDIT
"use strict";

var marko_template = module.exports = require("marko/src/html").t(__filename),
    marko_componentType = "/desenvolvedor-node$1.0.0/src/app/views/livros/form/form.marko",
...
function render(input, out, __component, component, state) {
  ...
  if (data.livro.id) {
    out.w("<div><input type=\"hidden\" name=\"id\"" +
...
marko_template.meta = {
    id: "/desenvolvedor-node$1.0.0/src/app/views/livros/form/form.marko",
    tags: [
